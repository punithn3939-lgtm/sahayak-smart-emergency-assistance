...
export function HospitalAuthForm({ mode }: { mode: 'login' | 'signup' }) {
  ...
  const submit=async(e:FormEvent)=>{
    ...
    if(mode==='signup'){
      ...
      if(error) setError(error.message); else if(data.session) setMessage('Application submitted. Your hospital account is awaiting verification.'); else setMessage('Application submitted. Confirm your email, then wait for hospital verification before signing in.');
    } else {
